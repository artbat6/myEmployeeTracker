...
class BLL {
  ...
  viewAllRoles() {
    return new Promise((resolve, reject) => {
      myDAL.getAllRolesWithDepartmentName().then((res) => {
        resolve(res);
      });
    });
  }
  ...
  viewAllDepartments() {
    return new Promise((resolve, reject) => {
      myDAL.getAllDepartments().then((res) => {
        resolve(
          res.map(({ name }) => {
            return { name: name };
          })
  ...
  async addRole(role) {
    return new Promise(async function (resolve, reject) {
      await myDAL.getAllRoles().then((res) => {
        if (
          res.find((e) => {
  ...
  async addEmployee(employee) {
    return new Promise(async function (resolve, reject) {
      await myDAL.getAllEmployees().then((res) => {
        if (
          res.find((e) => {
  ...
  async addDepartment(department) {
    return new Promise(async function (resolve, reject) {
      await myDAL.getAllDepartmentNames().then((res) => {
